...
# --- Degen topic keywords for classifying crypto posts ---
...
# --- Project Farming comment templates ---
# Purely positive, safe "reply guy" engagement. No controversy, no price talk,
# no opinions on competitors or regulation. Organized by vibe.
...
PROJECT_COMMENT_TEMPLATES = [
    ...
    "{project} never stops building",
    "{project} stays shipping",
    "ship ship ship",
    ...
    "proud to be here",
    "glad to be early",
    "community keeps winning",
    "vibes are immaculate",

    # --- Season / momentum ---
    "{project} szn",
    "{project} season is here",
    "the {project} ecosystem is thriving",
    "momentum is real",
    "can't stop won't stop",
    "{project} never stops",
    "every week is a new milestone",
    "onward and upward",
]

# Words/phrases that must never appear in a project comment.
# Catches offensive, controversial, or negative content if templates are edited.
PROJECT_BANNED_WORDS = [
    "scam", "rug", "rugged", "ponzi", "fraud",
    "dead", "dying", "rip",
    ...
    "hate", "trash", "garbage", "sucks", "terrible", "awful",
    "ngmi", "rekt",
    "buy", "price", "moon", "100x", "1000x",
    "nfa", "dyor", "financial advice",
    "kill", "die", "death",
]
...
# --- Post type classification for smart replies ---
...
def classify_post_type(text: str) -> tuple[str, str]:
    """Classify a post's type and return (type_name, reply_strategy).
    Returns ('general', generic_strategy) if no specific type matches."""
